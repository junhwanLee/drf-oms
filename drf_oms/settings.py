"""
Django settings for drf_oms project.
...
SECRET_KEY = 'uuw+p!l$t8yl+a181meox82z7yj5*c2v_hctvt7i4!@*g+v($='
...
WSGI_APPLICATION = 'drf_oms.wsgi.application'
